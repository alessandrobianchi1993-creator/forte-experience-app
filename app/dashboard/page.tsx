...
export default function DashboardPage() {
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 text-center">
      ...
      <p className="text-neutral-400 text-sm mb-12">La suite è riservata per te.</p>
      <div className="w-full max-w-sm bg-white text-black rounded-xl p-6 relative overflow-hidden">
        <div className="border-2 border-dashed border-neutral-300 p-4 rounded text-center">
           <h2 className="text-xl font-bold uppercase mb-1 italic">The Glass Suite</h2>
      ...
      <Link href="/" className="mt-12 text-neutral-500 text-xs hover:text-white transition-colors uppercase tracking-widest">
        Torna alla Home
      </Link>
    </main>
  );
